...
public class ProjectActivity extends AppCompatActivity {
    ...
    String[] ProjectUrl = new String[6];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cropNameText[0]=findViewById(R.id.Pcropname1);
        cropButton[0]=findViewById(R.id.Pcrop1);
        closeButton[0]=(ImageButton)findViewById(R.id.Pclose1);
        cropNameText[1]=findViewById(R.id.Pcropname2);
        cropButton[1]=findViewById(R.id.Pcrop2);
        closeButton[1]=findViewById(R.id.Pclose2);
        cropNameText[2]=findViewById(R.id.Pcropname3);
        cropButton[2]=findViewById(R.id.Pcrop3);
        closeButton[2]=findViewById(R.id.Pclose3);
        cropNameText[3]=findViewById(R.id.Pcropname4);
        cropButton[3]=findViewById(R.id.Pcrop4);
        closeButton[3]=findViewById(R.id.Pclose4);
        cropNameText[4]=findViewById(R.id.Pcropname5);
        cropButton[4]=findViewById(R.id.Pcrop5);
        closeButton[4]=findViewById(R.id.Pclose5);
        cropNameText[5]=findViewById(R.id.Pcropname6);
        cropButton[5]=findViewById(R.id.Pcrop6);
        closeButton[5]=findViewById(R.id.Pclose6);
        for(int q=0;q<6;q++)
        {
        ...
        documentReference.addSnapshotListener(ProjectActivity.this, new EventListener<DocumentSnapshot>() {
            @Override
                ...
                if(value.exists()) {
                    ...
                    while(true)
                    {
                        ...
                        if(index!=-1)
                        {
                            ...
                            subDoc.addSnapshotListener(ProjectActivity.this, new EventListener<DocumentSnapshot>() {
                                @Override
                                public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                                    ...
                                    if (value.exists()) {
                                        ...
                                        ProjectUrl[cropNumber] = value.get("project").toString();
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent openHomeActivity = new Intent(ProjectActivity.this, HomePage.class);
    ...
    private void firebaseDeleteRequested(int index)
    {
        ...
        delDoc.update(user).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(ProjectActivity.this, getString(R.string.crop_deleted), Toast.LENGTH_SHORT).show();
    ...
    {
        Intent openWebview = new Intent(ProjectActivity.this, WebViewActivity.class);
        openWebview.putExtra("pageTitle",cropNameText[index].getText().toString()+getString(R.string.Project_plan));
        openWebview.putExtra("url",ProjectUrl[index]);
